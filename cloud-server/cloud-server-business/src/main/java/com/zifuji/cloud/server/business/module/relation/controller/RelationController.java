...
public class FriendController {
    ...
    public Result<FriendInfoControllerVo> getFriendInfoById(@RequestParam String friendId) {
    ...
    public Result<DownloadFileVo> downloadFriendInfoImgFile(String id) throws IOException {
