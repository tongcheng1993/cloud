package com.zifuji.cloud.server.business.module.friend.service.impl;
...
import com.zifuji.cloud.server.business.module.friend.mapper.FriendMapper;
...
public class FriendServiceImpl implements FriendService {
    ...
    public String uploadFriendInfoImgFile(MultipartFile file) {
        return fileFeignClient.uploadFile("/friend/uploadFriendInfoImgFile", file).getResult();
    }

    @Override
    public MyFile downloadFriendInfoImgFile(Long id) throws IOException {
        return fileFeignClient.downloadFile("/friend/uploadFriendInfoImgFile", id).getResult();
    }
