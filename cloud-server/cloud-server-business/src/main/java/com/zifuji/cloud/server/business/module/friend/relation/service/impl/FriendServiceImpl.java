package com.zifuji.cloud.server.business.module.friend.relation.service.impl;
...
import com.zifuji.cloud.server.business.module.friend.relation.bo.FriendComponentMo;
import com.zifuji.cloud.server.business.module.friend.relation.mapper.FriendMapper;
...
public class FriendServiceImpl implements FriendService {
    ...
    @Override
    public FriendInfoControllerVo getFriendInfoById(Long friendId) {
        QueryWrapper<FriendInfoEntity> queryWrapper = new QueryWrapper<FriendInfoEntity>();
    ...
    @Override
    public BaseFile downloadFriendInfoImgFile(Long id) throws IOException {
