...
public class DicController {
    ...
    public Result<List<DicVo>> queryListDic(@RequestBody @Valid DicQo<DicEntity> dicQo) {
    ...
    public Result<IPage<DicVo>> queryPageDic(@RequestBody @Valid DicQo<DicEntity> dicQo) {
    ...
    public Result<List<DicItemVo>> queryListDicItem(@RequestBody @Valid DicItemQo<DicItemEntity> dicItemQo) {
