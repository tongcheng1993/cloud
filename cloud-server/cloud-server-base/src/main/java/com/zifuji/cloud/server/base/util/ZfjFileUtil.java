...
public class ZfjFileUtil {
	...
	public static FileItem createFileItem(InputStream inputStream, String fileName) {
		...
		FileItem fileItem = fileItemFactory.createItem(textFileName, MediaType.MULTIPART_FORM_DATA_VALUE, true,
				fileName);
		int byteRead = 0;
	...
	public static MultipartFile getMultipartFile(File file) {
		FileItem item = new DiskFileItemFactory().createItem("file", getMimeType(file.getName()), true, file.getName());
		try {
