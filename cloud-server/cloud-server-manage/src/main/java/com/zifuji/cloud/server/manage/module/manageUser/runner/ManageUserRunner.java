...
public class ManageUserRunner implements ApplicationRunner {
	...
	private void initPermission() {
		...
		for (String str : preAuthorizeExpressions) {
			try {
				...
				manageUserService.addManagePermission(addManagePermissionMo);
			}catch (Exception e) {
	...
	private void initMenu() {
			...
			manageMenuEntityQueryWrapper1.lambda()
					.eq(ManageMenuEntity::getParentId, m1.getParentId())
			...
			manageMenuEntityQueryWrapper2.lambda()
					.eq(ManageMenuEntity::getParentId, m2.getParentId())
			...
			manageMenuEntityQueryWrapper3.lambda()
					.eq(ManageMenuEntity::getParentId, m3.getParentId())
			...
			manageMenuEntityQueryWrapper4.lambda()
					.eq(ManageMenuEntity::getParentId, m4.getParentId())
			...
			manageMenuEntityQueryWrapper5.lambda()
					.eq(ManageMenuEntity::getParentId, m5.getParentId())
			...
			manageMenuEntityQueryWrapper6.lambda()
					.eq(ManageMenuEntity::getParentId, m6.getParentId())
			...
			manageMenuEntityQueryWrapper7.lambda()
					.eq(ManageMenuEntity::getParentId, m1.getParentId())
					.eq(ManageMenuEntity::getPath, m1.getPath());
